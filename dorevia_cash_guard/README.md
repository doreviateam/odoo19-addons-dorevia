...
| Entrée menu (sous Comptabilité) | **Projection de trésorerie** : **Cash Flow** (cockpit, `dorevia_cash_flow`) + **Cash Guards** (liste / atelier) + **Budgets** (réaffectation du menu budget standard sous la même racine) |
