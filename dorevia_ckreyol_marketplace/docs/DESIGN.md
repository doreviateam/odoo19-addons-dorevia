...
| 2026-04-21 | **§7** : blocs homepage — **Explorer** (cinq portes) documenté via **ADR-006 à 008** + **WIREFRAME** Bloc 3 ; suppression des renvois vers le dossier `docs/phase_2/` (abandonné). |
