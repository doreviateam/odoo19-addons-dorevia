...
| 2026-05-05 | [TICKET_COMPTE_CLIENT_MVP03.md](TICKET_COMPTE_CLIENT_MVP03.md) §4 : colonne **Décision figée** complétée depuis la recommandation ; complément technique **`crm` + `website_crm`** ; statut **§4 renseigné / GO dev avec réserve réduite**. |
