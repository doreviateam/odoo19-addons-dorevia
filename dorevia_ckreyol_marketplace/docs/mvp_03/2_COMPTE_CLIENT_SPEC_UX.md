...
- [ ] Distinction **clair**e entre entrée **particulier** et **demande pro** (pas de libellés ambigus).
...
| Sujet | Question |
|-------|----------|
| **Placement** | Demande pro : **page dédiée** vs **section** sur signup vs **modal** (déconseillé si charge cognitive). |
