...
- **Zone** : footer / stubs.
- **Description** : remplacer les stubs "Bientôt disponible" des pages légales (mentions légales, CGV, politique de confidentialité) par les contenus réels.
- **Critère d'acceptation** : pages publiées sous `/mentions-legales`, `/cgv`, `/confidentialite` avec contenu juridique validé.
