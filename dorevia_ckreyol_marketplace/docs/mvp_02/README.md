...
- **Hero (chantier 1/5)** : recette visuelle **GO MOA** — ticket **`HERO-HOMEPAGE-V2` accepté** ; preuve [PV_RECETTE_HERO_HOMEPAGE_V2_CK.md](../crea/PV_RECETTE_HERO_HOMEPAGE_V2_CK.md) **§8** (2026-04-24) ; tests auto verts (`dorevia_ckr_hero`). Affinages post-recette livrés (mobile/CTA/cadrage) : voir [1_HOMEPAGE.md](1_HOMEPAGE.md) §1 **État livré (2026-05)**.
