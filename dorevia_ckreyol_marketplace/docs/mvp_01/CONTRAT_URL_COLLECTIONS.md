...
| **Périmètre** | **Comportement visiteur**, **contrat d’URL**, **résolution**, **replis**, **signal éditorial**, **canonical**, **compatibilité filtrage boutique** — en cohérence avec [ADR-CKR-007](../direction/ARCHITECTURE_DECISION_RECORD.md#adr-ckr-007) (convergence `/shop`) et [SPEC_SHOP_PORTES §4.2](SPEC_SHOP_PORTES.md#42-collections). |
...
* la doctrine Explorer ([ADR-CKR-007](../direction/ARCHITECTURE_DECISION_RECORD.md#adr-ckr-007), [ADR-CKR-008](../direction/ARCHITECTURE_DECISION_RECORD.md#adr-ckr-008)) ;
