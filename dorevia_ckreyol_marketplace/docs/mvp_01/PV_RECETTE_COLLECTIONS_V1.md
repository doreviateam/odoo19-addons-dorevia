...
* [x] suite tagée **`dorevia_ckr_collections`** **exécutée** sur la version cible — preuves dans `docs/mvp_01/evidences/`
...
archivés : `docs/mvp_01/evidences/run_rc_collections_v2_summary.log`.)*
...
`docs/mvp_01/evidences/README.md` : retrait de `string=` sur `<group>`
