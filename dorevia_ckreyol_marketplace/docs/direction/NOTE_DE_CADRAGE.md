...
Le **socle technique cible** pour concrétiser la Phase 1 est **Odoo 19 Community Edition** : le présent cadrage est rédigé **en vue de son implémentation** (paramétrage, modules, flux e-commerce, stock et logistique selon le modèle retenu). Il complète le [README](../../README.md) du dépôt projet, la **[vision média-commerce](VISION_CK_MEDIA_COMMERCE.md)** (trois mondes : e-commerce, éditorial, communautaire — orientation long terme et garde-fous publicité, [ADR-CKR-009](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-009)), la **[doctrine e-commerce B2C / B2B](DOCTRINE_CK_ECOMMERCE_B2C_B2B.md)** (double lecture tarifaire sur catalogue commun, [ADR-CKR-010](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-010)), la **[doctrine langues créoles](DOCTRINE_CK_LANGUES_CREOLES.md)** (qualité, variantes, gouvernance — orientation long terme, [ADR-CKR-011](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-011)), le [guide exploitation i18n / devises](EXPLOITATION_I18N_DEVISES.md) (FR / EN / ES, Phase 1bis — distinct de la doctrine culturelle créoles), le [cadrage design / front-end](DESIGN.md), la [structure cible du menu principal](STRUCTURE_MENU_PRINCIPAL.md), le [wireframe homepage](WIREFRAME_HOMEPAGE.md), la [spec hero homepage](SPEC_HERO_HOMEPAGE.md), le [brief visuel hero Phase 1](BRIEF_VISUEL_HERO_PHASE1.md), la [charte graphique minimale Phase 1](CHARTE_GRAPHIQUE_PHASE1.md), le [brief synthétique direction artistique Phase 1](BRIEF_SYNTHETIQUE_CK.md) et les [directions artistiques Phase 1](DIRECTIONS_ARTISTIQUES_PHASE1.md).

Les **décisions d’architecture** structurantes sont consignées dans le [registre ADR](ARCHITECTURE_DECISION_RECORD.md) (à ce jour : **ADR-CKR-001** — doctrine de construction Phase 1, §3.5 ; **ADR-CKR-002** — spécifique Phase 1 présumé légitime = **front-end** uniquement ; **ADR-CKR-003** — **menu principal** et **footer** entièrement personnalisés en Phase 1 ; **ADR-CKR-004** — **modèle commercial Phase 1** : **achat-revente** (**C-Kreyol** vend au client final, **encaisse**, **achète** à **La Platine**) ; **ADR-CKR-005** — **modèle logistique cible** : **hub léger à Nantes**, **flux tendu**, **stock consigné** — avec **points ouverts** de consignation / propriété / Odoo à affiner, cf. §5.4 ; **ADR-CKR-006** à **008** — doctrine homepage / boutique / portes Explorer ; **ADR-CKR-009** — **vision média-commerce** à trois mondes et protection du tunnel d’achat ; **ADR-CKR-010** — **e-commerce B2C + B2B**, prix public conseillé / prix partenaire distributeur ; **ADR-CKR-011** — **langues créoles** dans l’expérience utilisateur, doctrine **culturelle** — **sans** mandat MVP).
...
### 3.0 Vision long terme (média-commerce)

Pour la **lecture stratégique** au-delà de la Phase 1 — **trois mondes** (e-commerce, éditorial, communautaire), doctrine de la **régie** et **zones protégées** du tunnel d’achat — voir **[VISION_CK_MEDIA_COMMERCE.md](VISION_CK_MEDIA_COMMERCE.md)** et **[ADR-CKR-009](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-009)**. Le **monde e-commerce** lui-même porte une **double cible** **B2C** / **B2B** (prix public conseillé / prix partenaire distributeur) : **[DOCTRINE_CK_ECOMMERCE_B2C_B2B.md](DOCTRINE_CK_ECOMMERCE_B2C_B2B.md)**, **[ADR-CKR-010](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-010)** — **sans élargir** d’office le périmètre **immédiat** des livrables (les implications §8 de la doctrine sont **orientations**). L’**accueil progressif des langues créoles** (qualité, variantes, gouvernance) est **acté** comme orientation long terme : **[DOCTRINE_CK_LANGUES_CREOLES.md](DOCTRINE_CK_LANGUES_CREOLES.md)**, **[ADR-CKR-011](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-011)** — **distinct** de l’**exploitation** FR / EN / ES ([EXPLOITATION_I18N_DEVISES.md](EXPLOITATION_I18N_DEVISES.md)) ; **ne prescrit pas** le MVP ni la Phase 1. Cette vision est **figée** comme orientation long terme et **structure** les arbitrages UX / éditoriaux / communautaires / publicitaires **sans élargir** le périmètre de **livraison immédiat** du MVP. **Acté** : toute évolution **publicitaire** ou **communautaire** ultérieure respecte la **protection du parcours e-commerce** — **aucune pollution publicitaire agressive** dans les zones d’achat (vision §6.1). La Phase 1 reste cadrée par les objectifs ci-dessous ; la vision n’impose pas la livraison immédiate de l’éditorial étendu ni du communautaire.
...
- **E-commerce double cible** ([ADR-CKR-010](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-010), [DOCTRINE_CK_ECOMMERCE_B2C_B2B.md](DOCTRINE_CK_ECOMMERCE_B2C_B2B.md)) : **B2C** (**prix public conseillé**) et **B2B** (**prix partenaire distributeur**) sur un **catalogue commun** ; **affichage commercial contextualisé** (prix visibles, remises, conditions de commande selon **statut**, **compte**, **pricelists** Odoo — doctrine **§2.1**) ; **sanctuarisation** du tunnel identique aux deux publics ([ADR-CKR-009](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-009)) — la **mise en œuvre** détaillée (comptes pro, parcours…) suit la doctrine §8 **sans** présumer du calendrier MVP
- **Langues créoles** ([ADR-CKR-011](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-011), [DOCTRINE_CK_LANGUES_CREOLES.md](DOCTRINE_CK_LANGUES_CREOLES.md)) : orientation **culturelle** long terme (variantes, traduction humaine qualifiée, gouvernance éditoriale, protection du tunnel §7 doctrine) — **sans** obligation de livraison Phase 1 / MVP ; **ne se confond pas** avec [EXPLOITATION_I18N_DEVISES.md](EXPLOITATION_I18N_DEVISES.md) (FR / EN / ES)
...
| 2026-04-26 | **[VISION_CK_MEDIA_COMMERCE.md](VISION_CK_MEDIA_COMMERCE.md)** + **[ADR-CKR-009](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-009)** : vision **média-commerce** trois mondes ; §1 documents liés ; nouveau **§3.0** ; §16 décisions — mention ADR-006 à 009. |
| 2026-04-26 | **§3.0** : formulation **actée** — vision figée long terme, sans élargir MVP ; règle **publicité / communauté** → protection zones d’achat. |
| 2026-04-26 | **§1** : **[DOCTRINE_CK_ECOMMERCE_B2C_B2B.md](DOCTRINE_CK_ECOMMERCE_B2C_B2B.md)** + **[ADR-CKR-010](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-010)** ; **§3.0** — double cible B2C/B2B (doctrine ≠ mandat livraison immédiate §8). |
| 2026-04-26 | **§1** : **[DOCTRINE_CK_LANGUES_CREOLES.md](DOCTRINE_CK_LANGUES_CREOLES.md)** + **[ADR-CKR-011](ARCHITECTURE_DECISION_RECORD.md#adr-ckr-011)** + **[EXPLOITATION_I18N_DEVISES.md](EXPLOITATION_I18N_DEVISES.md)** (distinction culturel / technique) ; **§3.0** ; liste ADR §1 ; **§16**. |
| 2026-05-05 | **[STRUCTURE_MENU_PRINCIPAL.md](STRUCTURE_MENU_PRINCIPAL.md)** : menu **Option B** — entrée **Communauté** avec sous-menus **Idées cadeaux**, **Recettes**, **Blog** ; renvois README, WIREFRAME, prompts, exploitation i18n. |