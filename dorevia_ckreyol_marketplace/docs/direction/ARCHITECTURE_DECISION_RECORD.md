...
3. **Devenir une façade stricte** (contrôleur CK) qui réexpose le rendu de `/shop` sans divergence — à condition que cette façade soit explicitement documentée et justifiée au cas par cas ([CONTRAT_URL_PACKS.md](../mvp_01/CONTRAT_URL_PACKS.md) pour la porte Kits/Pack).
...
- [mvp_01/SPEC_SHOP_PORTES.md](../mvp_01/SPEC_SHOP_PORTES.md) — spécification d’implémentation (contrats d’URL, sources de vérité, comportements sur `/shop`, vagues A/B/C).
...
| 2026-04-21 | Références **ADR-007 / 008** : [mvp_01/SPEC_SHOP_PORTES.md](../mvp_01/SPEC_SHOP_PORTES.md) (spécification d’implémentation portes → `/shop`, hors surcharge du corps des ADR). |
