...
| 2026-05-05 | Alignement menu **Option B** : **Communauté** (Idées cadeaux, Recettes, Blog) ; harmonisation des formulations sur **Idées cadeaux** ; cohérence [STRUCTURE_MENU_PRINCIPAL.md](STRUCTURE_MENU_PRINCIPAL.md) §10–§11. |
