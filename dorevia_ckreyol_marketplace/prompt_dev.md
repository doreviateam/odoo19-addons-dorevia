...
1. **Standard d’abord** — **ADR-CKR-001** (`docs/ARCHITECTURE_DECISION_RECORD.md`)  
...
5. **Explorer n’est pas le menu principal**  
   ...
   - `docs/STRUCTURE_MENU_PRINCIPAL.md` §11
   - `docs/WIREFRAME_HOMEPAGE.md` Bloc 3
...
| 4 | `docs/ARCHITECTURE_DECISION_RECORD.md` | ADR-CKR-001 à 008, surtout 001, 002, 007, 008 |
| 5 | `docs/WIREFRAME_HOMEPAGE.md` | Structure de la homepage et Bloc 3 Explorer |
| 6 | `docs/DESIGN.md` §7 | Synthèse des blocs homepage |
| 7 | `docs/phase_2/SPEC_SHOP_PORTES.md` | Vision d’ensemble des portes catalogue vers `/shop` |
| 8 | `docs/phase_2/CONTRAT_URL_*.md` et `docs/phase_2/SPEC_IMPL_*.md` | Détails de mise en œuvre selon la porte concernée |
