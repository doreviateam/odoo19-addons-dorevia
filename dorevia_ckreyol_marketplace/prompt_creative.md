...
- La navigation principale suit l’Option B gelée (Boutique, Collections, Offrir, Recettes, À propos, Contact) — cf. `docs/STRUCTURE_MENU_PRINCIPAL.md` §11.
...
- `docs/ARCHITECTURE_DECISION_RECORD.md` (ADR-001, 002, 007, 008)
- `docs/STRUCTURE_MENU_PRINCIPAL.md` §11
- `docs/CHARTE_GRAPHIQUE_PHASE1.md` (§3–§11 Direction A gelée)
- `docs/DIRECTIONS_ARTISTIQUES_PHASE1.md`
- `docs/WIREFRAME_HOMEPAGE.md` (Bloc 3 Explorer, « Présentation front »)
- `docs/SPEC_HERO_HOMEPAGE.md`
- `docs/BRIEF_VISUEL_HERO_PHASE1.md`
- `docs/DESIGN.md` §7
...
- `static/src/js/` (dont `ckr_entries_carousel.js` pour le rail Explorer)
- `__manifest__.py`
