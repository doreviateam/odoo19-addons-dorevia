# Note d’approche technique — futur `dorevia_ck_theme`

| Champ | Valeur |
|-------|--------|
| **Projet** | `dorevia_ck_marketone` |
| **Type** | Note d’approche Dev — préalable levée verrou Odoo |
| **Module cible** | `dorevia_ck_theme` (futur — **non créé**) |
| **Odoo cible** | 19 CE — `website`, `website_sale`, `website_crm` |
| **Références** | Maquette V1.1.1 validée QA · [`grille_traduction_odoo_v1.md`](./grille_traduction_odoo_v1.md) · [`note_transmission_arbitrage_david_01_v1_1.md`](./note_transmission_arbitrage_david_01_v1_1.md) · [`tokens.md`](./tokens.md) |
| **Date** | 2026-06-12 |
| **Statut** | **Validée MOA** — ticket 01 validé · exécution encadrée autorisée · verrou levé ticket 01 uniquement |
| **Canonique** | `docs/design/note_approche_technique_dorevia_ck_theme_01.md` (copie alignée) |
...
| Élément | Couche |
|---------|--------|
| Palette corail / vert | Variables SCSS `$ck-*` ([`tokens.md`](./tokens.md)) |
