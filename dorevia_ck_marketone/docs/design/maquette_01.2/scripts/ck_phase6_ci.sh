#!/usr/bin/env bash
# Gate portable Phase 6 — /contactus · /a-propos CK · sans Playwright.
#
#   1. upgrade dorevia_ck_theme
#   2. tests Odoo --test-tags=dorevia_ck_theme_phase6
#   3. smoke curl /contactus · /a-propos · non-régression Phases 1–5
#
# Usage :
#   ./ck_phase6_ci.sh
#   CK_CI_DB=ma_base CK_CI_BASE_URL=http://localhost:8069 ./ck_phase6_ci.sh
...
TEST_TAG="dorevia_ck_theme_phase6"
...
log "Gate portable Phase 6 · base=${DB} · modules=${MODULES}"
...
curl_smoke "/contactus" "ck-contact-page" "contactus_form" "mail.mail" "/professionnels" "<html" "web.assets_frontend"
curl_smoke_absent "/contactus" "Ma société" "Fake Buena Vista"
curl_smoke "/a-propos" "ck-about-page" "Notre mission" 'href="/shop"' 'href="/professionnels"' 'href="/contactus"' "<html" "web.assets_frontend"
curl_smoke "/professionnels" "ck-pro-page" "ck-pro-form" "crm.lead" "<html" "web.assets_frontend"
...
log "Gate portable Phase 6 : OK"
log "Recette UX complémentaire (optionnelle) :"
printf '  node %s/ck_phase6_desktop1280.mjs\n' "$ROOT"
printf '  node %s/ck_phase6_mobile390.mjs\n' "$ROOT"
