...
class TestGlcAnalyticSetup(TransactionCase):
    ...
    def test_plans_exist(self):
        plan_activites = self.env.ref("dorevia_glc_analytique.analytic_plan_glc_activites")
        plan_financements = self.env.ref("dorevia_glc_analytique.analytic_plan_glc_financements")
    ...
    def test_activity_accounts_count_and_codes(self):
        plan = self.env.ref("dorevia_glc_analytique.analytic_plan_glc_activites")
    ...
    def test_financement_accounts_count_and_codes(self):
        plan = self.env.ref("dorevia_glc_analytique.analytic_plan_glc_financements")
        accounts = self.env["account.analytic.account"].search([("plan_id", "=", plan.id)])
    ...
    def test_glc_activity_types_set(self):
        structure = self.env.ref("dorevia_glc_analytique.analytic_account_glc_structure")
        bar = self.env.ref("dorevia_glc_analytique.analytic_account_glc_bar")
        adhesions = self.env.ref("dorevia_glc_analytique.analytic_account_glc_adhesions")
    ...
    def test_security_groups_exist(self):
        self.assertTrue(self.env.ref("dorevia_glc_analytique.group_glc_user"))
        self.assertTrue(self.env.ref("dorevia_glc_analytique.group_glc_manager"))
