...
class TestGlcSalaryAllocation(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env.ref("base.user_admin").group_ids += cls.env.ref(
            "dorevia_glc_analytique.group_glc_manager"
        )
        ...
        cls.prestations = cls.env.ref("dorevia_glc_analytique.analytic_account_glc_prestations")
    ...
    def test_menus_salary_allocation_exist(self):
        ...
        cost_menu = self.env.ref("dorevia_glc_analytique.menu_glc_employee_cost_lines")
        alloc_menu = self.env.ref("dorevia_glc_analytique.menu_glc_salary_allocations")
        self.assertEqual(
            cost_menu.action.id,
            self.env.ref("dorevia_glc_analytique.action_glc_employee_cost_line").id,
        )
        self.assertEqual(
            alloc_menu.action.id,
            self.env.ref("dorevia_glc_analytique.action_glc_salary_allocation").id,
        )
