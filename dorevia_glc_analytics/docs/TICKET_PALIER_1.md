...
**Paramètre :** `dorevia_glc_analytics.cutover_date` — si absent, contrôle **désactivé** ou mode informatif (warning wizard).
...
**Seuil :** `dorevia_glc_analytics.structure_weight_alert_pct` (défaut documenté : 30 %).
