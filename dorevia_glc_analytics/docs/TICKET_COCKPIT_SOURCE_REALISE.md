...
**Branche :** *(à ouvrir après validation MOA du cadrage)*  
**Version cible :** `19.0.4.7.0` *(indicatif — à confirmer à l'implémentation)*  
**Statut :** **Cadrage MOA — écart fonctionnel identifié** (2026-05-28) — **en attente validation MOA**  
...
| Point | Décision MOA |
|---|---|
| Doctrine : réalisé = écritures charge/produit + analytique, **avec ou sans facture** | ☐ GO · ☐ NO GO |
| Comptes 631/633/641/645 → **SALAIRES** via compta analytique | ☐ GO · ☐ NO GO |
| Rôle ventilations Palier 2 (R1 / R2 / R3 / R4) | ☐ R1 · ☐ R2 · ☐ R3 · ☐ R4 |
| Règle anti-double comptage (détail à valider) | ☐ GO · ☐ NO GO |
| Exclusions 411/401/512/53 confirmées | ☐ GO · ☐ NO GO |
| Révision cadrage I2/I3 ([CADRAGE_FINAL_PALIER_4.md](./CADRAGE_FINAL_PALIER_4.md)) | ☐ GO · ☐ NO GO |
| GO implémentation post-cadrage (`19.0.4.7.0` indicatif) | ☐ GO · ☐ NO GO |
...
## 12. Verdict MOA provisoire (2026-05-28)
...
| Correctif immédiat dans PR laptop CSS (#38) | **NO GO** — cadrage préalable requis |
| Ouverture ticket cadrage | **GO** — ce document |
| Prochaine étape | Validation MOA section 10 → implémentation `19.0.4.7.0` |
