# -*- coding: utf-8 -*-
"""Migration 21.9 — cache-bust visuels univers (?v=5)."""
...
def migrate(cr, version):
    ...
    if not bootstrap_home_univers(env):
        raise RuntimeError('CK univers migration 21.9: bootstrap_home_univers a échoué')
    ...
    if f'?v={UNIVERS_IMAGES_VERSION}' not in arch:
        raise RuntimeError('CK univers migration 21.9: cache-bust visuels absent')
