...
Non-régression complète (Lots 1–6.2 + Culture v1) : **85** post-tests, **0** failed — tags `dorevia_marketone_smoke` … `dorevia_marketone_culture_v1` (voir [`ENV_REFERENCE.md`](../reference/ENV_REFERENCE.md)).
