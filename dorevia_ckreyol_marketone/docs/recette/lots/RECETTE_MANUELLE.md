...
Document opérationnel pour validation **humaine** (MOA). Les tests automatisés restent la référence technique : voir [`ENV_REFERENCE.md`](../reference/ENV_REFERENCE.md).
...
Images source possible : [`ASSETS_REFERENCE.md`](../reference/ASSETS_REFERENCE.md).
...
| Document | Usage |
|----------|--------|
| [`ENV_REFERENCE.md`](../reference/ENV_REFERENCE.md) | Infra, commandes, modules interdits |
| [`ASSETS_REFERENCE.md`](../reference/ASSETS_REFERENCE.md) | Images produits recette |
| [`tickets/TICKET_MARKETONE_LOT4_PRODUCT.md`](../../tickets/lots/TICKET_MARKETONE_LOT4_PRODUCT.md) | Périmètre Lot 4 |
| [`tickets/TICKET_MARKETONE_LOT2_1_DESIGN_SYSTEM_MINIMAL.md`](../../tickets/lots/TICKET_MARKETONE_LOT2_1_DESIGN_SYSTEM_MINIMAL.md) | Référence enveloppe |
