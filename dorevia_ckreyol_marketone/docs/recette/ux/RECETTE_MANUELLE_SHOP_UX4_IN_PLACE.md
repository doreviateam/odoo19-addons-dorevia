...
| **Statut recette** | **Lot 1 — GO avec réserve MOA** (`11.1`) · **Lot 2 — NO GO `12.0`** · correctif **`12.1`** à rejouer · Lots 3–4 gelés |
...
> **Statut :** **NO GO `12.0`** · correctif **`12.1`** — recette § L2 à rejouer.
