...
| **Statut recette** | **Lot 1 — GO avec réserve MOA** (`11.1`) · **Lot 2 — NO GO `12.1`** · correctif **`12.2`** à rejouer · Lots 3–4 gelés |
...
> **Statut :** **NO GO `12.1`** · correctif **`12.2`** — recette § L2 à rejouer.
