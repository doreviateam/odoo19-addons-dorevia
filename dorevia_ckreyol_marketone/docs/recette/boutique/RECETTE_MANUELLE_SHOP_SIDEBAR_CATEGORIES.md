...
| Champ | Valeur |
|-------|--------|
| **Ticket** | [`TICKET_MARKETONE_SHOP_SIDEBAR_FILTRES_CATEGORIES`](../../tickets/boutique/TICKET_MARKETONE_SHOP_SIDEBAR_FILTRES_CATEGORIES.md) |
...
| **4b-R** | Liste au 1er clic | Cocher **Épices** seule | Autres principales **restent visibles** (correctif C4 — document attendu : `RECETTE_MANUELLE_SHOP_SIDEBAR_CATEGORIES_C4_MULTI.md`, absent du dépôt) | ☑ | ☑ |
