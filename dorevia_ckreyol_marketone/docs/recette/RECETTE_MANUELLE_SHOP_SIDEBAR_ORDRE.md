...
|---|----------|-----------|---------|-----|------|
| **O8** | C4 catégories | [`RECETTE_MANUELLE_SHOP_SIDEBAR_CATEGORIES_C4_MULTI.md`](RECETTE_MANUELLE_SHOP_SIDEBAR_CATEGORIES_C4_MULTI.md) | Multi-sélection catégories toujours possible | ☑ | ☑ |
...
| C4 multi | [`RECETTE_MANUELLE_SHOP_SIDEBAR_CATEGORIES_C4_MULTI.md`](RECETTE_MANUELLE_SHOP_SIDEBAR_CATEGORIES_C4_MULTI.md) |
