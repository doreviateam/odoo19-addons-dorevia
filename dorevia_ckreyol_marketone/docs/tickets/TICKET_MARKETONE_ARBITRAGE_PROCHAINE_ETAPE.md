...
→ [`TICKET_MARKETONE_SAVOIRS_V1_CADRAGE.md`](TICKET_MARKETONE_SAVOIRS_V1_CADRAGE.md)
...
|----------------|--------|
| Savoirs v1 | [`TICKET_MARKETONE_SAVOIRS_V1_CADRAGE.md`](TICKET_MARKETONE_SAVOIRS_V1_CADRAGE.md) |

---

## Prochaine étape

1. **MOA** : valider le cadrage [`TICKET_MARKETONE_SAVOIRS_V1_CADRAGE.md`](TICKET_MARKETONE_SAVOIRS_V1_CADRAGE.md) (D1–D10).
...
| Document | Rôle |
|----------|------|
| [`TICKET_MARKETONE_SAVOIRS_V1_CADRAGE.md`](TICKET_MARKETONE_SAVOIRS_V1_CADRAGE.md) | Cadrage en cours |
