...
- Créer **2 à 3 produits de recette en BO** pour valider cartes `/shop` et fiche produit — **pas de seed XML** dans le module. Images : banque `dorevia_ckreyol_marketplace/docs/assets/` (`homepage_*`, `exemple_produit_*`) — voir `docs/recette/reference/ASSETS_REFERENCE.md` (ADR-020).
...
- `pilotage/ROADMAP.md`, `recette/reference/ENV_REFERENCE.md`, `docs/README.md`
...
**Plan de recette** : [`docs/recette/RECETTE_MANUELLE_LOT4.md`](../../recette/lots/RECETTE_MANUELLE_LOT4.md) (fiche Lot 4) · plan complet [`RECETTE_MANUELLE.md`](../../recette/lots/RECETTE_MANUELLE.md)
...
**Plan** : [`docs/recette/RECETTE_MANUELLE_LOT4.md`](../../recette/lots/RECETTE_MANUELLE_LOT4.md)
