...
|----------------|-------------------|
| Rubrique **Collections** | [`RECETTE_MANUELLE_SHOP_SIDEBAR_COLLECTIONS.md`](../recette/RECETTE_MANUELLE_SHOP_SIDEBAR_COLLECTIONS.md) |
| Rubrique **Catégories** + C4 | [`RECETTE_MANUELLE_SHOP_SIDEBAR_FACETTES_CONTEXTUELLES.md`](../recette/RECETTE_MANUELLE_SHOP_SIDEBAR_FACETTES_CONTEXTUELLES.md) · [`RECETTE_MANUELLE_SHOP_SIDEBAR_CATEGORIES_C4_MULTI.md`](../recette/RECETTE_MANUELLE_SHOP_SIDEBAR_CATEGORIES_C4_MULTI.md) |
| **Ordre** rubriques | [`RECETTE_MANUELLE_SHOP_SIDEBAR_ORDRE.md`](../recette/RECETTE_MANUELLE_SHOP_SIDEBAR_ORDRE.md) |
| **Effacer les filtres** | [`RECETTE_MANUELLE_SHOP_SIDEBAR_CATEGORIES.md`](../recette/RECETTE_MANUELLE_SHOP_SIDEBAR_CATEGORIES.md) |
...
| Document | Lien |
|----------|------|
| Recette ordre (réserves) | [`RECETTE_MANUELLE_SHOP_SIDEBAR_ORDRE.md`](../recette/RECETTE_MANUELLE_SHOP_SIDEBAR_ORDRE.md) |
| Ticket C4 | [`TICKET_MARKETONE_SHOP_SIDEBAR_FACETTES_CONTEXTUELLES.md`](TICKET_MARKETONE_SHOP_SIDEBAR_FACETTES_CONTEXTUELLES.md) |
