...
| — | [`tickets/TICKET_MARKETONE_CONSOLIDATION_PORTES_BOUTIQUE.md`](tickets/TICKET_MARKETONE_CONSOLIDATION_PORTES_BOUTIQUE.md) | **Ouvert** — cadrage portes 6.1 + 6.2 (pas de code) |
